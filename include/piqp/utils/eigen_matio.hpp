...
struct matio_flag
{
    static const matio_flags fid = (matio_flags) 0;
};
// specializations
// template <> struct matio_type<xxx>       { typedef xxx type; matio_types id = MAT_T_UNKNOWN;                   };
template<>
struct matio_type<int8_t>
{
    typedef int8_t type;
    static const matio_types tid = MAT_T_INT8;
};
template<>
struct matio_type<uint8_t>
{
    typedef uint8_t type;
    static const matio_types tid = MAT_T_UINT8;
};
template<>
struct matio_type<int16_t>
{
    typedef int16_t type;
    static const matio_types tid = MAT_T_INT16;
};
template<>
struct matio_type<uint16_t>
{
    typedef uint16_t type;
    static const matio_types tid = MAT_T_UINT16;
};
template<>
struct matio_type<int32_t>
{
    typedef int32_t type;
    static const matio_types tid = MAT_T_INT32;
};
template<>
struct matio_type<uint32_t>
{
    typedef uint32_t type;
    static const matio_types tid = MAT_T_UINT32;
};
template<>
struct matio_type<float>
{
    typedef float type;
    static const matio_types tid = MAT_T_SINGLE;
};
template<>
struct matio_type<double>
{
    typedef double type;
    static const matio_types tid = MAT_T_DOUBLE;
};
template<>
struct matio_type<long double>
{
    typedef double type;
    static const matio_types tid = MAT_T_DOUBLE;
};
template<>
struct matio_type<int64_t>
{
    typedef int64_t type;
    static const matio_types tid = MAT_T_INT64;
};
template<>
struct matio_type<uint64_t>
{
    typedef uint64_t type;
    static const matio_types tid = MAT_T_UINT64;
};
...
template<typename Tp>
struct matio_type<std::complex<Tp>>
{
...
template<>
struct matio_class<char>
{
    static const matio_classes cid = MAT_C_CHAR;
};
// template <> struct matio_class<xxx>       { static const matio_classes cid = MAT_C_SPARSE;   };
template<>
struct matio_class<float>
{
    static const matio_classes cid = MAT_C_SINGLE;
};
template<>
struct matio_class<double>
{
    static const matio_classes cid = MAT_C_DOUBLE;
};
template<>
struct matio_class<long double>
{
    static const matio_classes cid = MAT_C_DOUBLE;
};
template<>
struct matio_class<int8_t>
{
    static const matio_classes cid = MAT_C_INT8;
};
template<>
struct matio_class<uint8_t>
{
    static const matio_classes cid = MAT_C_UINT8;
};
template<>
struct matio_class<int16_t>
{
    static const matio_classes cid = MAT_C_INT16;
};
template<>
struct matio_class<uint16_t>
{
    static const matio_classes cid = MAT_C_UINT16;
};
template<>
struct matio_class<int32_t>
{
    static const matio_classes cid = MAT_C_INT32;
};
template<>
struct matio_class<uint32_t>
{
    static const matio_classes cid = MAT_C_UINT32;
};
template<>
struct matio_class<int64_t>
{
    static const matio_classes cid = MAT_C_INT64;
};
template<>
struct matio_class<uint64_t>
{
    static const matio_classes cid = MAT_C_UINT64;
};
// template <> struct matio_class<xxx>       { static const matio_classes cid = MAT_C_FUNCTION; };
template<typename Tp>
struct matio_class<std::complex<Tp>>
{
    static const matio_classes cid = matio_class<Tp>::cid;
};

template<typename Tp>
struct matio_flag<std::complex<Tp>>
{
...
template<int matio_type_id = -1>
struct type_matio
{};
template<int matio_class_id = -1>
struct class_matio
{};
template<>
struct type_matio<MAT_T_INT8>
{
    typedef int8_t type;
};
template<>
struct type_matio<MAT_T_UINT8>
{
    typedef uint8_t type;
};
template<>
struct type_matio<MAT_T_INT16>
{
    typedef int16_t type;
};
template<>
struct type_matio<MAT_T_UINT16>
{
    typedef uint16_t type;
};
template<>
struct type_matio<MAT_T_INT32>
{
    typedef int32_t type;
};
template<>
struct type_matio<MAT_T_UINT32>
{
    typedef uint32_t type;
};
template<>
struct type_matio<MAT_T_SINGLE>
{
    typedef float type;
};
template<>
struct type_matio<MAT_T_DOUBLE>
{
    typedef double type;
};
template<>
struct type_matio<MAT_T_INT64>
{
    typedef int64_t type;
};
template<>
struct type_matio<MAT_T_UINT64>
{
    typedef uint64_t type;
};

template<>
struct class_matio<MAT_C_DOUBLE>
{
    typedef double type;
};
...
#define MATIO_HANDLE_READ_TYPE(MAT_T_X)                              \
    else if (var->data_type == MAT_T_X) do                           \
    {                                                                \
